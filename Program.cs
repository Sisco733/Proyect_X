internal class Program
{
    private static void Main(string[] args)
    {
        ...
        if (n2 >= 1000)
        {
            ...
            Console.WriteLine("TIENES " + n2 + " SELECCIONE EL NUMERO DEL PLATILLO NAVIDEÑO DESEADO, A CORDE A SU PRESUPUESTO");
            Console.WriteLine("1- APERITIVOS");
            Console.WriteLine("2- COMIDA");
            Console.WriteLine("3- CENA");
            Console.WriteLine("4- POSTRE");
            Console.WriteLine("5- BEBIDA");
            ...
            if (n3 == 1)
            {
                ...
                Console.WriteLine("FELICIDADES escogiste " + n4 + " tu receta es esta");
                if (n4 == 1)
                {
                    Console.WriteLine("1 COMPRAR FRITURAS");
                    nop = String.Format(Console.ReadLine());
                    Console.WriteLine("2 SERVIR EN UN PLATON ");
                    nop = String.Format(Console.ReadLine());
                    Console.WriteLine("3 HECHARLE UN CHINGO DE SALSA");
                    nop = String.Format(Console.ReadLine());
            ...
            {
                Console.WriteLine("HAS ESCOGIDO LA OPCION DE COMIDA, LOS PLATILLOS SON LOS SIGUIENTES, ESCOGE UN NUMERO DE UN PLATILLO:");
                ...
                if (n5 == 2) 
                {
                    ...
                    nop = String.Format(Console.ReadLine());
                    Console.WriteLine("SERVIMOS EN UN PLATON Y A DISFRUTAR");
            ...
            {
                Console.WriteLine("HAS ESCOGIDO LA OPCION DE CENA, LOS PLATILLOS SON LOS SIGUIENTES:");
            ...
            {
                Console.WriteLine("HAS ESCOGIDO LA OPCION DE POSTRE, LOS PLATILLOS SON LOS SIGUIENTES:");
        ...
        if (n2 >= 100 && n2 <=1000 )
        {
            Console.WriteLine("tienes poco presupuesto, pero por suerte, tenemos mas platillos economicos para ti:");
